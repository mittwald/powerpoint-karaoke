...
import {type KeywordInput, keywordInputSchema} from "@shared/schema";
        ...
        <div className="w-full max-w-2xl space-y-6">
                                            ...
                                            <FormItem>
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        ...
                                                        <SelectItem value="medium">Medium (Moderately
                                                            Absurd)</SelectItem>
                                                        <SelectItem value="hard">Hard (Completely
                                                            Ridiculous)</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                                <FormMessage/>
                                            </FormItem>
            ...
            <div className="space-y-3 mt-6">
                <div className="text-center text-sm text-primary-foreground/80">
                    ...
                    >
                        Built with <Heart className="h-3.5 w-3.5 fill-red-500 text-red-500 mx-0.5"/> and mittwald AI
                        hosting
                    </a>
